...
- **PR body:** ≤3 sentences + a per-AC verification list. Root cause and investigation live in the issue — link it, never re-derive it. No `## Summary`, no restating the diff, no checklist theater.
